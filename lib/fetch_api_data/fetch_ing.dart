...
import '../api_concept_test/data/fetch_recipie.dart';
import 'package:http/http.dart' as http;

class SpoonacularData {
  final String apiKey;
  SpoonacularData({required this.apiKey});

  Future<List<Future<RecipeWithDetails>>> fetchRecipes(
      String apiKey, String ingridients) async {
    final url = Uri.parse(
        "https://api.spoonacular.com/recipes/search?apiKey=$apiKey&includeIngredients=$ingridients");
